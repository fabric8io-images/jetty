...
A simple docker build for installing a vanilla Jetty 9.4.9.v20180320 below */opt/jetty*. It comes out of the box and is intended for use in integration tests
