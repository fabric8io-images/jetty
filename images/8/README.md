...
A simple docker build for installing a vanilla Jetty 8.1.21.v20160908 below */opt/jetty*. It comes out of the box and is intended for use in integration tests
...
* Jetty Version: **8.1.21.v20160908**
